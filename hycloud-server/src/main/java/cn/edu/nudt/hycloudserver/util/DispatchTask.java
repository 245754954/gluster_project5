...
public class DispatchTask implements  Runnable {
    ...
    public void run() {
        try {
            ...
            hash = DispatchHandler.get_hash_with_blocknumber_and_challenge(up.getFilename_and_path(),blocksize1,offset,up.getChallenge(),blocknumber1,real_size1,dest_offset);
