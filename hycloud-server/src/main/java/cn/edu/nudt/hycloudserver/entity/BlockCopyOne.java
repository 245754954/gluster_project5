...
@Entity
@Table(name = "BlockCopyOne")
public class BlockCopyOne {
    @Id
    ...
    public BlockCopyOne(@NotNull String filename, @NotNull Integer blockIdx, @NotNull String hash, @NotNull Integer status) {
