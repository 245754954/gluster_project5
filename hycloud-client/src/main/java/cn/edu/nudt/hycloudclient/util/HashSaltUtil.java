...
//        System.out.println(st.getBytes("GBK")[0]);
//
...
//    }
    ...
    //验证hash是否相等
    public static boolean verify(String inputStr ,String md5){

        String salt = getSaltFromHash(md5);

        if(MD5WithSalt(inputStr,salt).equals(md5))
            return true;
        else
            return false;
    }
